...
public void envoyerMailPersonnelDateExamen() throws MessagingException{
...
//		if(Jexamen-JAujourdhui==3&Mexamen-MAujourdhui==0&-Yexamen-YAujourdhui==0){
			...
			buf.append("\"<html>\n" + "  <head>\n" + "    <meta name=\"viewport\" content=\"width=device-width\" />\n"
					...
					+ "                    <span class=\"apple-link\">TunisairTechnics,Tunisie</span>\n"
					+ "                  </td>\n" + "                </tr>\n" + "                <tr>\n"
			...
			MimeMessage message = javaMailSender.createMimeMessage();
			   ...
			   helper.setTo("firas.warteni15@gmail.com"); 
			   helper.setFrom("tunisairtechnicstest@gmail.com");
